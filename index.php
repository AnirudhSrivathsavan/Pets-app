...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width,initial-scale=1.0, maximum-scale=1.50">
...
<body>
    ...
    <div class="fluid-container">
        <div class="row">
            <div class="col-sm-2 col-md-2 col-lg-2 slidebutton">
                <h1>Donate now!</h1>
            </div>
    ...
    <div class="qr" style="align-items: center;">
        <div class="row" style="font-size: small; ">
            <div class="col qrtext" style=" ">
                GET OUR PETS' APP</div>
        </div>
        <div class="row">
            <div class="col ">
                <img src="assets/qrcode.png" alt="QR unavailable" width="130" height="130">
            </div>
        </div>
