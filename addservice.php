...
<head>
    ...
    <link rel="stylesheet" href="addservice.html">
...
<body>
<header class="header opaque-element">
        <div class="row">
            <div class="col-sm-0 col-md-1 col-lg-3"></div>
            <div class="col-sm-2 col-md-2 col-lg-1">
                <img src="assets/logo-icon-removebg-preview.png" alt="" srcset="" height="130">
            </div>
            <div class="col-sm-2 col-md-3 col-lg-5">
                <img src="assets/logo-title-removebg-preview.png" alt="" srcset="" height="130" style="    padding-left: 20px;">
            </div>
                    ...
                    <ul class="slides">
                        <li class="slide">
                            <div class="slide-content">
                                ...
                                <a href="testpage/donations.html" class="slide-link">Donate now</a>
                            </div>
                            <p class="slide-image">
                        ...
                        <li class="slide">
                            <div class="slide-content">
                                ...
                                <a href="testpage/insurance.html" class="slide-link">Learn more</a>
                            </div>
                            <p class="slide-image">
        ...
        <div class="row">
            <div class="col">
                <div class="form-container">
                    <form action="addservice.php" id="myform" method="post" enctype="multipart/form-data" autocomplete="off">
                        <div class="row">
                            <div class="col">
                        ...
                        <div class="row">
                            <div class="col"><label for="zipcode">Zipcode:</label></div>
                            <div class="col"><input type="text" id="zipcode" name="zipcode" pattern="\d{5}" required></div>
                        </div>
                        
                        <div class="row">
                            <div class="col">
                                <label for="byline">Tag Line:</label>
                            </div>
                            <div class="col">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <textarea id="avail" name="avail" rows="4"></textarea>
                            </div>
                        </div>
